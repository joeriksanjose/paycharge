...
<div class="row">
    ...
    <div class="span12">
        <h2>
            ...
            <small>( <?php echo $award_info["transaction_name"] ?> )</small>
        </h2>
        <hr>
    </div>
    <div class="span12" id="new-rate" style="display: none;">
        <div class="alert alert-error" id="error_div" style="display: none;"></div>
        <form class="form-horizontal" id="frm-new-rate" action="<?php echo base_url("client_agreement/saveRate"); ?>" method="post">
            <input type="hidden" name="award_no" value="<?php echo $award_info["trans_no"] ?>">
            <input type="hidden" name="transaction_name" value="<?php echo $award_info["transaction_name"] ?>">
