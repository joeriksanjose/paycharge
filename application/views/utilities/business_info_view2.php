...
<div class="row">
    ...
    <div class="span4">
        ...
        <?php endif; ?>
        <?php 
        $attributes = array("id"=>"frm-company2", "class"=>"form-horizontal centerDiv");
        echo form_open_multipart("utilities1/business_company/upload2", $attributes)?>
