<?php echo $header?>
    ...
    <p>1.1 “Consultant” shall mean <?php echo $company?> Pty Ltd and its successors and assigns.</p>
	...
	<p>2.3 None of the Consultant’s agents or representatives are authorised to make any representation, statements, conditions or agreements not expressed by the manager of the Consultant in writing nor is the Consultant bound by any such unauthorised statements.</p>
	...
	<p style="padding-left: 10px">a) use its best endeavours to provide Candidates as requested b the Client; and</p>
	...
	<p>4.4 The Consultant will invoice the Client weekly for the total hours worked by each Temporary Candidate at the applicable hourly rate for that week. In addition to the standard hourly change, further changes will apply in accordance with any relevant federal or state award.</p> 

	<p><b>5. Payment</b></p>
	<p>5.1 Time for payment for the services shall be of the essence will be stated on the invoice, quotation or any other order forms. If not time is stated then payment shall be on delivery of the Services.</p>
	...
	<p>5.3 Payment will be made by cash on delivery, or by cheque, or by bank cheque, or by direct debit, or by any other method as agreed to between the Client and the Consultant.</p>
	...
	<p>10.1 Nothing in this agreement is intended to have the affect of contracting our of an applicable provisions of the Commonwealth Competition and Consumer Act 2010 or the Fair Trading Acts in each of the States and Territories of Australian, except to the extend permitted by those Acts where applicable.</p>
	
	<p><b>11. Default and Consequences of Default</b></p>
	...
	<p>11.3 Without prejudice to any other remedies the Consultant may have, if at any tie the Client is in breach of any obligation (including those relating to payment), the Consultant may suspend or terminate the supply of Services to the Client and any of its other obligations under the terms and conditions. The Consultant will not be liable to the Client for any loss or damage the Client suffers because the Consultant exercised its rights under this clause.</p>
	<p>11.4 If any account remains unpaid at the end of the second month after supply of the Services the following shall apply: An immediate amount of the greater of $50.00 or 10.00% of the amount overdue shall be levied for administration fees which sums shall become immediately due and payable.</p>
	...
	<p style="padding-left: 10px">d) then without prejudice to the Consultant’s other remedies at law:</p>
	<p style="padding-left: 20px">i) the Consultant shall be entitled to cancel all or any part of any order of the Client which remains underperformed in addition to and without prejudice to any other remedies; and</p>
	<p style="padding-left: 20px">ii) all amounts owing to the Consultant shall, whether or not due for payment, immediately become payable.</p>
	...
	<p>14.2 Minimum booking for Temporary Candidates is 8 hours. Cancellation of booking must allow Temporary Candidates travelling time from home to place of assignment. Otherwise, a few of four hours is payable at quoted rates.</p>
	...
	<p>14.5 The Consultant will pay Temporary Candidates and invoice the Client on the basis of working hours shown on the Consultant’s timesheet. The Client undertakes to have each weekly timesheet of each Temporary Candidate approved and endorsed by an authorised person employed by the Client.</p>
	<p>14.6 Should you, the Client, require the services of a Consultant Temporary Candidate at any time within six months of termination of temporary employment, a booking must be made through the Consultant. Should the Consultant’s Temporary Candidate be placed as a permanent member of a Client’s staff within six months of the completion of the Temporary Candidate’s assignment, the Consultant’s placement fee will apply.</p>
	...
	<p>15.3 The Consultant shall be under no liability whatsoever to the client for any indirect loss and/or expense (including loss of profit) suffered by the Client arising out of a breach by the Consultant of these terms and conditions.</p>
	<p>15.4 In the event of any breach of this contract by the Consultant the remedies of the Client shall be limited to damages. Under no circumstances shall the liability of the Consultant exceed the Fee of the Services.</p>
	<p>15.5 The Client shall not set off against the Fee amounts due from the Consultant.</p>
	<p>15.6 The Consultant reserves the right to review these terms and conditions at any time and from time to time. If, following any such review, there is to be any change in such terms and conditions, that change will take effect from the date on which the Consultant notifies the Client of such change/</p>
    ...
    <!-- <label class="radio"><input type="radio" name="rdoAgree">I agree</label>
    <label class="radio"><input type="radio" name="rdoAgree">I do not agree</label>
