	    ...
	    <div id="div">
			<table class="table table-bordered table-striped" id="award-table" style="margin-top: 15px;">
				...
				<tr>
					...
					<td>
					    <a class="btn edit-award-btn" href="<?php echo base_url("reports/rate_confirmation/print_modern/".$modern_award["trans_no"]."/".$modern_award["modern_award_no"]); ?>"><i class="icon-print"></i></a>
					</td>
				</tr>
				<?php endforeach ; ?>
				<?php else : ?>
