$(document).ready(function(){
   ...
   $("#btn-add").click(function(){
    ...
    $("#trans_no").keyup(function(){
        $.post(base_url+"sales/home/checkRateTransno", {trans_no:$(this).val()}, function(data){
   ...
   $("#add-new-rate").click(function(){
       $("#frm-new-rate").attr("action", base_url+"sales/home/saveRate");
       $(this).hide("fast");
       $("#new-rate").show("fast");
   ...
   $("#delete-btn-modal").click(function(){
      $.post(base_url+"sales/home/ajaxDeleteRate", {del_id:del_id}, function(data){
        res = $.parseJSON(data);
        if (res.status) {
   ...
   $(".btn-edit").click(function(){
       ...
       $.post(base_url+"sales/home/ajaxGetRateInfo", {edit_id:edit_id}, function(data){
          res = $.parseJSON(data);
          if (res.status) {
              $("#frm-new-rate").attr("action", base_url+"sales/home/updateRate");
