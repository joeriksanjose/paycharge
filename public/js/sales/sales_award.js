              ...
              alert("Database Error");
                ...
                if (res.awards.length > 0) {
                    $.each(res.awards, function(i, item){
                        ...
                        str = str + '<li>'
                        str = str + '<a target="_blank" href="'+base_url+'reports/allowance/print_modern/'+item.trans_no+'/'+item.modern_award_no+'">'
                        str = str + '<i class="icon-print"></i> Allowance</a></li>'
                        str = str + '<li>'
                        str = str + '<a target="_blank" href="'+base_url+'reports/paycharge_rate/print_modern/'+item.trans_no+'/'+item.modern_award_no+'">'
